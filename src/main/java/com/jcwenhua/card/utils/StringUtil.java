...
public class StringUtil {
     ...
     * 替换指定的子串，替换所有出现的子串。
     *
     * <p> 如果字符串为<code>null</code>则返回<code>null</code>，如果指定子串为<code>null</code> ，则返回原字符串。 </p>
     *
     * @param text 要扫描的字符串
     * @param repl 要搜索的子串
     * @param with 替换字符串
     ...
     *
     * <p> 注意，和<code>String.trim</code>不同，此方法使用<code>Character.isWhitespace</code> 来判定空白，
     * 因而可以除去英文字符集之外的其它空白，如中文空格。 </p>
     *
     * @param str 要处理的字符串
    ...
    /**
     * 除去字符串尾部的空白，如果字符串是<code>null</code>，则返回<code>null</code>。 </p>
     *
     * @param str 要处理的字符串
     * @return 除去空白的字符串，如果原字串为<code>null</code>或结果字符串为<code>""</code>，则返回 <code>null</code>
     */
    ...
    /**
     * Check if a String has length. <p>
     *
     ...
     * 将字符串转换成小写。
     *
     * <p> 如果字符串是<code>null</code>则返回<code>null</code>。 </p>
     *
     * @param str 要转换的字符串
     ...
     * 取得指定子串在字符串中出现的次数。
     *
     * <p> 如果字符串为<code>null</code>或空，则返回<code>0</code>。
     *
     * </p>
     *
     * @param str    要扫描的字符串
