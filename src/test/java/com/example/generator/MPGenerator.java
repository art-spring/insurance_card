...
//        strategy.setTablePrefix("bmd_");// 此处可以修改为您的表前缀
        ...
        strategy.setInclude( new String[]{"admin","agent","card","card_type","customer","export_history","joinin","policy","shop","shop_type"});
        ...
        pc.setParent("com.example.card2");
        pc.setController("controller");

//        pc.setModuleName("card");
